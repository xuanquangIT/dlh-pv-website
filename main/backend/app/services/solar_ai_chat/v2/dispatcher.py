"""Solar Chat v2 — dispatcher.

Maps a function-call name (from the LLM) → primitive call → result envelope.
This is the v2 analogue of v1's ToolExecutor, but ~50 lines instead of ~700.
...
from app.services.solar_ai_chat.v2 import primitives
...
class V2Dispatcher:
    """Dispatches LLM function calls to v2 primitives.
    ...
    def execute(
        ...
        try:
            ...
            logger.warning(
                "v2_dispatch_error fn=%s args=%s err=%s",
